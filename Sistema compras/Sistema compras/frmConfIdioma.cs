...
{
    public partial class frmConfIdioma : Form
    {
        
        public frmConfIdioma()
        {
            InitializeComponent();
        ...
        private void frmConfIdioma_Load(object sender, EventArgs e)
        {
            comboBox1.Items.Add(new ComboItem("Español", 0));
            comboBox1.Items.Add(new ComboItem("English", 1));
        }
